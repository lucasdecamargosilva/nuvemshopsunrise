(function () {
    ...
    (function() {
        function injectPLBadge() {
            try {
                ...
                a.href = 'https://provoulevou.com.br?utm_source=widget&utm_medium=lojista&utm_campaign=sunrise';
                a.target = '_blank';
                a.rel = 'noopener';
    ...
    // ===============================================
    const apiKey = "pl_live_8f1d676b3ca00c1ececd57e158da6ed878215d89178fda2da5be0161ea087c94";
    ...
    const WEBHOOK_CHECK_LIMIT = 'https://n8n.segredosdodrop.com/webhook/sunrise-check-limit';
...
/* PL: borda arredondada do modal */@media(min-width:768px){.q-card-ia,.q-card,#q-card-ia,#q-card,.q-modal-card{border-radius:16px !important;overflow:hidden;}}
            ...
            <div class="q-card-ia">
                ...
                <div class="q-content-scroll">
                    ...
                    <div id="q-header-provador">
                        ...
                        <img src="https://acdn-us.mitiendanube.com/stores/894/881/themes/common/logo-1087189635-1656523708-d13e216d67ab137a1f05bb28b05038871656523708-320-0.webp" alt="ÓCULOS SUNRISE" style="height:76px;width:auto;"/>
                    </div>
                    ...
                    <div id="q-loading-box">
                        <div class="q-loading-texts">
                            ...
                            <a href="https://provoulevou.com.br?utm_source=widget&utm_medium=lojista&utm_campaign=sunrise" target="_blank" class="q-loading-t2">
                ...
                <a href="https://provoulevou.com.br?utm_source=widget&utm_medium=lojista&utm_campaign=sunrise" target="_blank" class="q-powered-footer">
                    <span>Powered by</span>
    ...
    function init() {
        ...
        const SUNRISE_STORE_WHATSAPP = '5511913981394';
        function showLimitWhatsApp() {
            ...
            if (link) {
                ...
                link.href = 'https://wa.me/' + SUNRISE_STORE_WHATSAPP + '?text=' + encodeURIComponent(msg);
            ...
            try {
                ...
                if (pending) {
                    ...
                    const resp = await fetch(WEBHOOK_PIX, {
                        method: 'POST',
                        headers: { 'Content-Type': 'application/json' },
                        body: JSON.stringify({ email: 'cliente@provoulevou.com.br', phone, loja: 'sunrise', origin: location.origin })
                    });
                    pix = await resp.json();
...
const fd = new FormData();
                    ...
                    console.log('[PL Sunrise] Enviando', allProdImgs.length, 'fotos do produto');
